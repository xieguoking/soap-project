...
package com.shdata.gateway.plugin.soap.client;

public class OdocExchangeWebServiceLocator extends org.apache.axis.client.Service implements com.shdata.gateway.plugin.soap.client.OdocExchangeWebService {

    public OdocExchangeWebServiceLocator() {
    }

    public OdocExchangeWebServiceLocator(String address) {
    ...
    private java.lang.String OdocExchangeWebServiceHttpPort_address = "http://61.129.165.86:8080/services/OdocExchangeWebService?wsdl";
    //private java.lang.String OdocExchangeWebServiceHttpPort_address = "http://192.168.2.84:6001/odoc/login";
    ...
    public com.shdata.gateway.plugin.soap.client.OdocExchangeWebServicePortType getOdocExchangeWebServiceHttpPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.shdata.gateway.plugin.soap.client.OdocExchangeWebServicePortType getOdocExchangeWebServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.shdata.gateway.plugin.soap.client.OdocExchangeWebServiceHttpBindingStub _stub = new com.shdata.gateway.plugin.soap.client.OdocExchangeWebServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.shdata.gateway.plugin.soap.client.OdocExchangeWebServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.shdata.gateway.plugin.soap.client.OdocExchangeWebServiceHttpBindingStub _stub = new com.shdata.gateway.plugin.soap.client.OdocExchangeWebServiceHttpBindingStub(new java.net.URL(OdocExchangeWebServiceHttpPort_address), this);
                _stub.setPortName(getOdocExchangeWebServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
